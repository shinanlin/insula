...
The distributed ``*_IFHW_r95_zy.nii.gz`` labels have the same voxel arrays as
their paired T1 images but historical, displaced affines.  This utility never
edits the licensed raw archives.  It verifies array shape and foreground
alignment, then writes label copies with the paired T1 geometry for future
multi-atlas propagation.
"""
