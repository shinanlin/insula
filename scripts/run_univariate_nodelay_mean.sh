#!/bin/bash
# Phase-window mean univariate: LexicalNoDelay, ~26 subjects.
#SBATCH --job-name=univ_mean_nodelay
#SBATCH --output=/hpc/group/coganlab/nanlinshi/insula/logs/slurm/univariate_mean_nodelay_%A_%a.out
#SBATCH --error=/hpc/group/coganlab/nanlinshi/insula/logs/slurm/univariate_mean_nodelay_%A_%a.err
