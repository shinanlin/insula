#!/bin/bash
# LexicalDelay Response window-decode sweep for lexicality.
# Axes: Response crop × PCA variance × LinearSVC C × {Sensory,Sustain,Motor} × {Repeat,Decision}.
...
RESULTS_ROOT="/hpc/group/coganlab/nanlinshi/insula-functional/results/decoding_sweep/LexicalDelay_lexicality_window_response"
REF=bipolar
BAND=highgamma
DATATYPE=lexicality
PHASE=Response
