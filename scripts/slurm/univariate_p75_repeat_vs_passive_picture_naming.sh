#!/bin/bash
# PictureNaming sound Repeat vs Passive using 75th-percentile window peaks.
#SBATCH --job-name=univ_rvp_pn_p75
#SBATCH --output=/hpc/group/coganlab/nanlinshi/insula-functional/logs/slurm/univariate_p75_rvp_pn_%A_%a.out
#SBATCH --error=/hpc/group/coganlab/nanlinshi/insula-functional/logs/slurm/univariate_p75_rvp_pn_%A_%a.err
