#!/bin/bash
# LexicalDelay Decision vs Repeat using 75th-percentile window peaks (Delay only).
#SBATCH --job-name=univ_dvr_ld_p75
#SBATCH --output=/hpc/group/coganlab/nanlinshi/insula-functional/logs/slurm/univariate_p75_dvr_ld_%A_%a.out
#SBATCH --error=/hpc/group/coganlab/nanlinshi/insula-functional/logs/slurm/univariate_p75_dvr_ld_%A_%a.err
