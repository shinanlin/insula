#!/bin/bash
# Phase-window mean univariate: LexicalNoDelay Repeat vs Passive.
#SBATCH --job-name=univ_rvp_nodelay
#SBATCH --output=/hpc/group/coganlab/nanlinshi/insula-functional/logs/slurm/univariate_mean_rvp_nodelay_%A_%a.out
#SBATCH --error=/hpc/group/coganlab/nanlinshi/insula-functional/logs/slurm/univariate_mean_rvp_nodelay_%A_%a.err
