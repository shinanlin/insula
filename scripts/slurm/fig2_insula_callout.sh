#!/bin/bash
#SBATCH --job-name=fig2_pies
#SBATCH --output=/hpc/group/coganlab/nanlinshi/insula-functional/logs/slurm/fig2_pies_%j.out
#SBATCH --error=/hpc/group/coganlab/nanlinshi/insula-functional/logs/slurm/fig2_pies_%j.err
...
print("=== exec fig2-callout-plot ===", flush=True)
exec("".join(cells["fig2-callout-plot"]["source"]), ns)
