#!/bin/bash
# Phase-window mean univariate: LexicalDelay, ~52 subjects.
#SBATCH --job-name=univ_mean_delay
#SBATCH --output=/hpc/group/coganlab/nanlinshi/insula/logs/slurm/univariate_mean_delay_%A_%a.out
#SBATCH --error=/hpc/group/coganlab/nanlinshi/insula/logs/slurm/univariate_mean_delay_%A_%a.err
